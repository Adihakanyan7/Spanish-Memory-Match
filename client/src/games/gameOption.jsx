...
function GameOption(props) {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:3001/memory-game/categories") // Replace with your server's URL and endpoint
  ...
  function handlePlay() {
    ...
    fetch(`http://localhost:3001/memory-game/words/${content.category}`)
      .then((response) => response.json())
      .then((data) => {
